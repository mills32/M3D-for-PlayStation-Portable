...
So this is a brief description of everything M3D does. For more details, read the samples and M3D.h file (Incomplete, I'm adding add comments for all functions needed).
