...
SIMD_FORCE_INLINE btScalar btCos(btScalar x) { return vfpu_cosf(x); }
SIMD_FORCE_INLINE btScalar btSin(btScalar x) { return vfpu_sinf(x); }
SIMD_FORCE_INLINE btScalar btTan(btScalar x) { return vfpu_tanf(x); }
SIMD_FORCE_INLINE btScalar btAcos(btScalar x) { if (x<btScalar(-1))	x=btScalar(-1); if (x>btScalar(1))	x=btScalar(1); return vfpu_acosf(x); }
SIMD_FORCE_INLINE btScalar btAsin(btScalar x) { if (x<btScalar(-1))	x=btScalar(-1); if (x>btScalar(1))	x=btScalar(1); return vfpu_asinf(x); }
SIMD_FORCE_INLINE btScalar btAtan(btScalar x) { return vfpu_atanf(x); }
SIMD_FORCE_INLINE btScalar btAtan2(btScalar x, btScalar y) { return vfpu_atan2f(x, y); }
SIMD_FORCE_INLINE btScalar btExp(btScalar x) { return vfpu_expf(x); }
SIMD_FORCE_INLINE btScalar btLog(btScalar x) { return vfpu_logf(x); }
SIMD_FORCE_INLINE btScalar btPow(btScalar x,btScalar y) { return powf(x,y); }
SIMD_FORCE_INLINE btScalar btFmod(btScalar x,btScalar y) { return vfpu_fmodf(x,y); }
...
#define SIMD_PI           btScalar(3.141592)
#define SIMD_2_PI         btScalar(2.0) * SIMD_PI
#define SIMD_HALF_PI      (SIMD_PI * btScalar(0.5))
#define SIMD_RADS_PER_DEG (SIMD_2_PI / btScalar(360.0))
#define SIMD_DEGS_PER_RAD  (btScalar(360.0) / SIMD_2_PI)
#define SIMDSQRT12 btScalar(0.707106)
